...
public class LineProgressBar extends View{
	   ...
	   private Paint mPaint;
	    ...
	    public LineProgressBar(Context context, AttributeSet attrs,
	        ...
	        try {
	            mMax = a.getInt(R.styleable.LineProgressBar_max, DEFAULT_MAX);
	            mProgress = a.getInt(R.styleable.LineProgressBar_progress,
	                    DEFAULT_PROGRESS);
	            mRadius = (int) a.getDimension(
	                    R.styleable.LineProgressBar_progressRadius, DEFAULT_RADIUS);
	            mProgressColor = a.getColor(
	                    R.styleable.LineProgressBar_lineprogressColor,
	                    DEFAULT_PROGRESS_COLOR);
	            mProgressDescColor = a.getColor(
	                    R.styleable.LineProgressBar_progressDescColor,
	                    DEFAULT_PROGRESS_DESC_COLOR);
	            mBorderWidth = (int) a.getDimension(
	                    R.styleable.LineProgressBar_lineborderWidth,
	    ...
	    private void drawProgressDesc(Canvas canvas) {
	        ...
	        String finalProgressDesc = mProgressDesc + " " + mProgressStr + "/" + mMaxStr;
	     ...
	     * @param progress
	     */
	    @SuppressLint("NewApi") public void setCurProgress (final int progress) {

	        ObjectAnimator animator = ObjectAnimator.ofInt(this, "progress", progress).setDuration(1500);
	        mProgressStr = FormetFileSize(mProgress);
	     ...
	     * @param duration ����ʱ��
	     */
	    @SuppressLint("NewApi") public void setCurProgress (final int progress,long duration) {
	     ...
	     * @return
	     */
	    public String FormetFileSize(int fileS) { 
